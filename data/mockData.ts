...
export const mockListings: Listing[] = [
  {
    ...
    description: 'شقة واسعة مؤثثة بالكامل تتكون من 3 غرف وصالة، مثالية لطلاب جامعة النجاح الوطنية، قريبة من الخدمات والمطاعم والمواصلات العامة.',
    price: 1500,
    location: 'نابلس، شارع تونس، بالقرب من الحرم الجديد',
    category: 'students',
    image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=800',
    features: ['تكييف سريع', 'إنترنت فايبر', 'مواقف سيارات', 'مصعد', 'صيانة مجانية'],
    type: 'apartment',
    status: 'available',
    isPending: false,
  ...
  },
  {
    ...
    description: 'غرفة مفردة في سكن مخصص للطالبات، يتميز بالأمن والخصوصية التامة، بالقرب من كليات الحرم القديم وصيدلية رفيديا.',
    price: 1200,
    ...
    features: ['أمن وحراسة', 'بيئة دراسية هادئة', 'قريب من المواصلات', 'تكييف', 'غسالة ملابس'],
    type: 'room',
    status: 'available',
    isPending: false,
    ownerName: 'أم محمد',
  ...
  },
  {
    ...
    description: 'استوديو عصري مصمم بشكل رائع، إطلالة جبلية خلابة، وقريب من منطقة الأكاديمية ومجمع التدريب المهني.',
    price: 900,
    location: 'نابلس، منطقة الأكاديمية، خلف الجامعة',
    category: 'students',
    image: 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&q=80&w=800',
    features: ['مطبخ متكامل', 'إطلالة بانورامية', 'سعر شامل الكهرباء والماء', 'أثاث جديد'],
    type: 'studio',
    status: 'available',
    isPending: false,
  ...
  },
  {
    ...
    description: 'شقة راقية للطالبات، نظام غرف مزدوجة ومفردة، أثاث جديد جداً وخدمات صيانة فورية على مدار الساعة.',
    price: 1800,
    location: 'نابلس، شارع رفيديا، مقابل المستشفى العربي',
    category: 'studentesses',
    image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&q=80&w=800',
    features: ['خدمة تنظيف', 'تدفئة مركزية', 'دخول آمن', 'كاميرات مراقبة', 'إطلالة'],
    type: 'apartment',
    status: 'available',
    isPending: false,
  ...
  },
  {
    ...
    description: 'شقة مريحة تناسب 4 طلاب، قريبة من المطاعم والخدمات المركزية، مجهزة بكافة الأدوات المنزلية.',
    price: 1300,
  ...
  },
  {
    ...
    description: 'رووف مميز جداً به إطلالة كاشفة لمدينة نابلس، مجهز بجلسة خارجية رائعة وتدفئة ممتازة.',
    price: 2200,
    location: 'نابلس، الجبل الشمالي، شارع عصيرة',
    category: 'studentesses',
    image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800',
    features: ['تراس واسع', 'أثاث VIP', 'هدوء تام', 'غسالة ونشاف', 'ديكورات حديثة'],
    type: 'apartment',
    status: 'available',
    isPending: false,
    ownerName: 'ليلى صالح',
  ...
  },
  {
    ...
    description: 'استوديو صغير ومناسب من حيث التكلفة لطالب واحد، هادئ وقريب من مكتبة الجامعة.',
    price: 700,
    location: 'نابلس، المساكن الشعبية',
    category: 'students',
    image: 'https://images.unsplash.com/photo-1536376111523-e3b2bb618398?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    description: 'شقة جديدة في منطقة الضاحية الراقية، هدوء تام وأمان، مخصصة للطالبات الدارسات في المجمع الصحي.',
    price: 2000,
  ...
  },
  {
    ...
    description: 'غرفة واسعة تتسع لطالبين مع حمام خاص ومطبخ مشترك، إطلالة رائعة على نابلس القديمة.',
    price: 800,
  ...
  },
  {
    ...
    description: 'سكن مرخص مجهز بكل سبل الراحة والأمان، مشرفات مقيمات، وجبات طعام اختيارية، وبيئة اجتماعية مميزة.',
    price: 1600,
